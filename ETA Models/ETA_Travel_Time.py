import ast
# difference in file
from myTaxiCab import taxicab as tc
import pandas as pd
import numpy as np
import pickle
import os
...
eta_results.to_csv('outputs/eta_travel_time.csv', index=False)
...
final_results.to_csv('outputs/eta_travel_time.csv', index=False)
